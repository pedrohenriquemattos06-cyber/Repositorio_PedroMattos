...
--Insert--
    INSERT INTO TB_FROTA_VEICULOS (PLACA, MODELO, KM_ATUAL, STATUS) 
    VALUES ('DOG-2012', 'VW GOL G5', 400500, 'ATIVO');

    INSERT INTO TB_FROTA_VEICULOS (PLACA, MODELO, KM_ATUAL, STATUS) 
    VALUES ('AUD-2016', 'AUDI A3 SEDAN', 85000, 'ATIVO');

    INSERT INTO TB_FROTA_VEICULOS (PLACA, MODELO, KM_ATUAL, STATUS) 
    VALUES ('CHE-2023', 'CHEVROLET ONIX', 12400, 'ATIVO');

    INSERT INTO TB_FROTA_VEICULOS (PLACA, MODELO, KM_ATUAL, STATUS) 
    VALUES ('FIAT-001', 'FIAT STRADA', 150000, 'MANUTENCAO');

    INSERT INTO TB_FROTA_VEICULOS (PLACA, MODELO, KM_ATUAL, STATUS) 
    VALUES ('TOY-2020', 'TOYOTA COROLLA', 62000, 'ATIVO');

    INSERT INTO TB_FROTA_VEICULOS (PLACA, MODELO, KM_ATUAL, STATUS) 
    VALUES ('FORD-99', 'FORD KA', 210000, 'VENDIDO');
